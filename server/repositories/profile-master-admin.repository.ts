...
export async function deleteEmploymentType(id:number){await db.query(`DELETE FROM profile_employment_types WHERE id=?`,[id]);}
...
export async function deleteOrgUnit(id:number){await db.query(`DELETE FROM profile_org_units WHERE id=?`,[id]);}
...
export async function deleteBank(id:number){await db.query(`DELETE FROM profile_bank_masters WHERE id=?`,[id]);}
...
export async function deleteDesignation(id:number){await db.query(`DELETE FROM profile_designation_masters WHERE id=?`,[id]);}
...
export async function deleteStream(id:number){await db.query(`DELETE FROM profile_stream_masters WHERE id=?`,[id]);}
...
export async function deleteMscBatch(id:number){await db.query(`DELETE FROM profile_msc_batches WHERE id=?`,[id]);}
...
export async function deleteCourse(id:number){await db.query(`DELETE FROM profile_course_masters WHERE id=?`,[id]);}
...
export async function deleteTraineeBatch(id:number){await db.query(`DELETE FROM profile_trainee_batches WHERE id=?`,[id]);}
