...
export async function updateOrgUnitStatus(
  ...
  try {
    ...
    console.error(
      "UPDATE profile org unit status ERROR:",
      error,
    );
...
export async function updateBankStatus(
  ...
  try {
    ...
    console.error(
      "UPDATE profile bank status ERROR:",
      error,
    );
...
export async function updateBatchStatus(
  ...
  try {
    ...
    console.error(
      "UPDATE profile batch status ERROR:",
      error,
    );
