...
export function registerProfileMasterAdminRoutes(app: Express) {
  ...
  app.delete("/api/admin/profile-masters/employment-types/:id", authenticateToken, administrator, controller.deleteEmploymentType);
  ...
  app.delete("/api/admin/profile-masters/org-units/:id", authenticateToken, administrator, controller.deleteOrgUnit);
  ...
  app.delete("/api/admin/profile-masters/banks/:id", authenticateToken, administrator, controller.deleteBank);
  ...
  app.delete("/api/admin/profile-masters/designations/:id", authenticateToken, administrator, controller.deleteDesignation);
  ...
  app.delete("/api/admin/profile-masters/streams/:id", authenticateToken, administrator, controller.deleteStream);
  ...
  app.delete("/api/admin/profile-masters/msc-batches/:id", authenticateToken, administrator, controller.deleteMscBatch);
  ...
  app.delete("/api/admin/profile-masters/courses/:id", authenticateToken, administrator, controller.deleteCourse);
  ...
  app.delete("/api/admin/profile-masters/trainee-batches/:id", authenticateToken, administrator, controller.deleteTraineeBatch);
