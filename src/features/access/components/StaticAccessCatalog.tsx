...
export const STATIC_ACCESS_ITEMS: StaticAccessItem[] = [
  ...
  { key: "research-laboratory", title: "Labs & Facility", subtitle: "Individual laboratory and facility names will be maintained within this master", emptyTitle: "No Active Labs & Facility Access", description: "Select the required laboratory or facility from the Labs & Facility master and submit the applicable access requisition.", buttonLabel: "Apply for Labs & Facility Access", scope: "lab", kind: "facility", color: "bg-teal-600", icon: FlaskConical },
];
