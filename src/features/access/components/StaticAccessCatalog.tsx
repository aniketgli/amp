...
import { Fingerprint, FlaskConical, Mail, PlusCircle, ShieldCheck, Wifi } from "lucide-react";
...
export function StaticAccessCatalog({ onApply }: { onApply: (item: StaticAccessItem) => void }) {
  return (
