...
interface FacilitiesServicesSectionProps {
  facilitiesList: any[]; facilitiesLoading: boolean; facilitiesError: string | null; fetchFacilities: () => void; setIsAddFacilityModalOpen: (open: boolean) => void; handleToggleFacilityStatus: (facility: any) => void; handleOpenWorkflowModal: (type: "facility" | "service", item: any) => void; setEditingFacility: (facility: any) => void; handleDeleteFacility: (id: any) => void;
