  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-8">
      ...
      <div className="bg-slate-900 text-white rounded-2xl p-5 sm:p-6 border border-slate-800 shadow-md relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-5 min-h-[140px]">
        ...
        <div className="z-10 relative space-y-1.5 max-w-2xl">
        ...
        {currentRole !== 'applicant' && (
          <div className="z-20 relative w-full md:w-auto min-w-[300px] sm:min-w-[360px] shrink-0">
            <div className="flex items-center justify-between gap-2 mb-1.5">
              <label className="text-[11px] font-extrabold text-slate-300 uppercase tracking-wider block">
                Directory Search & Select
              </label>
              <span className="text-[10px] text-emerald-300 font-bold bg-emerald-950/80 border border-emerald-800/80 px-2 py-0.5 rounded">
                OFFICIAL DIRECTORY
              </span>
            </div>

            <div className="relative">
              <div className="flex items-center bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs focus-within:ring-2 focus-within:ring-emerald-500 shadow-inner gap-2">
                ...
                <input
                  ...
                  className="bg-transparent text-white placeholder-slate-400 focus:outline-none w-full font-medium text-xs min-w-[120px]"
                />
                {profileSearchQuery && (
                  <button
                    type="button"
                ...
                <div className="pl-2 border-l border-slate-700 shrink-0">
                  <select
                    ...
                    className="bg-slate-900 border border-slate-700 text-emerald-400 text-[11px] font-bold rounded-lg px-2 py-1 cursor-pointer focus:outline-none max-w-[140px] sm:max-w-[160px] truncate"
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Section 2: Address */}
        <div className="bg-white rounded-xl border border-slate-200 shadow-2xs p-5 space-y-3.5">
          <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
            <h2 className="text-xs font-bold uppercase text-slate-800 tracking-wider flex items-center gap-2">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-2xs p-5 space-y-3.5">
          <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
            <h2 className="text-xs font-bold uppercase text-slate-800 tracking-wider flex items-center gap-2">
              ...
              4. Cadre, Project Tenure & Supervising Officer (PI)
            </h2>
          </div>
