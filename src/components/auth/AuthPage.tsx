                ...
                <div className="p-3.5 bg-slate-100 border border-slate-200 rounded-2xl space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold text-slate-800 flex items-center gap-1">
                      ...
                      Quick Demo Login Accounts (Click to auto-fill):
                    </span>
                  ...
                  <div className="flex flex-wrap gap-1.5 text-[11px]">
                    <button
                      type="button"
                      onClick={() => {
                        setLoginEmail("aniketkarangli@gmail.com");
                        setLoginPassword("password123");
                        setUserCaptchaInput(captchaCode);
                        setFormError(null);
                        setIsInactiveUserError(false);
                      }}
                      className="px-2.5 py-1 rounded-lg bg-white border border-emerald-300 text-emerald-900 font-bold hover:bg-emerald-50 transition-all shadow-2xs"
                    >
                      User / Applicant
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setLoginEmail("admin@wii.gov.in");
                        setLoginPassword("password123");
                        setUserCaptchaInput(captchaCode);
                        setFormError(null);
                        setIsInactiveUserError(false);
                      }}
                      className="px-2.5 py-1 rounded-lg bg-white border border-purple-300 text-purple-900 font-bold hover:bg-purple-50 transition-all shadow-2xs"
                    >
                      Administrator
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setLoginEmail("rksingh@wii.gov.in");
                        setLoginPassword("password123");
                        setUserCaptchaInput(captchaCode);
                        setFormError(null);
                        setIsInactiveUserError(false);
                      }}
                      className="px-2.5 py-1 rounded-lg bg-white border border-blue-300 text-blue-900 font-bold hover:bg-blue-50 transition-all shadow-2xs"
                    >
                      Supervisor / PI
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setLoginEmail("skgupta@wii.gov.in");
                        setLoginPassword("password123");
                        setUserCaptchaInput(captchaCode);
                        setFormError(null);
                        setIsInactiveUserError(false);
                      }}
                      className="px-2.5 py-1 rounded-lg bg-white border border-teal-300 text-teal-900 font-bold hover:bg-teal-50 transition-all shadow-2xs"
                    >
                      Lab Nodal
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setLoginEmail("it.cell@wii.gov.in");
                        setLoginPassword("password123");
                        setUserCaptchaInput(captchaCode);
                        setFormError(null);
                        setIsInactiveUserError(false);
                      }}
                      className="px-2.5 py-1 rounded-lg bg-white border border-amber-300 text-amber-900 font-bold hover:bg-amber-50 transition-all shadow-2xs"
                    >
                      IT Officer
                    </button>
                  </div>
